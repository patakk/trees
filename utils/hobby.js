...
export function makeknots(p, tension, cycle) {
  tension = tension || 1;
...
export function gethobbypoints(knots, cycle, det=12){
    var hobbypts = [];
    for (var i=0; i<knots.length; i++) {
...
export function drawhobby(ctx, knots, cycle) {
    ...
    ctx.moveTo(knots[0].x_pt, knots[0].y_pt, 0);
